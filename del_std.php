...
if(!isset($_SESSION['user_name'])){
    header("location:page.html");
      ...
      if(isset($_POST['sub'])){
          ...
          $r=mysqli_query($db,$s);
          $s2="SELECT * from student where roll_no='$id'";
          $rs2=mysqli_query($db,$s2);
          if(mysqli_num_rows($r)==1 and mysqli_num_rows($rs2)==1){
              
              $s1="DELETE from student where roll_no='$id' ";
              ...
              echo "<script> alert('STUDENT ROLL NO NOT EXISTS') </script>";
          }
      }
  }
  ?>
  ...
  <html>
      ...
      <body>
      <div id='mid'>
        <button onclick="window.location.href='view_std.php' ;">VIEW STUDENT</button>
       </div>
       <div class="login_form">
            <h1 align="center"><u><i>DETAILS</i></u></h1>
            <form action="del_std.php" method="POST">
